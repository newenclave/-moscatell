...
namespace {
    ...
    class srpc_svc_impl: public rpc::tuntap::server_instance {
    ...
    public:
        ...
        srpc_svc_impl( application *app,
                       noname::client_wptr client,
                       device_info_sptr device )
            :app_(app)
            ,client_(client.lock( ).get( ))
            ,device_(device)
        ...
        {
            namespace ph = std::placeholders;
            pusher_ = std::bind( &srpc_svc_impl::push_disconnect, this,
                                 ph::_1, ph::_2, ph::_3, ph::_4 );
            start_timer( 30 );
        }
