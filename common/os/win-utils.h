...
struct charset {
    static std::basic_string<char> make_mb_string( LPCWSTR src, UINT CodePage = CP_ACP )
    {
    ...
    static std::basic_string<wchar_t> make_ws_string( LPCSTR src, UINT CodePage = CP_ACP )
    {
    ...
    static std::wstring make_ws_string( const std::string &src, UINT CodePage = CP_ACP )
    {
        return make_ws_string( src.c_str( ), CodePage );
    }
    static std::string make_mb_string( const std::wstring &src, UINT CodePage = CP_ACP )
    {
